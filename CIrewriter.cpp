    ...
    : public RecursiveASTVisitor<MyRecursiveASTVisitor>
{
  ...
  *low-level RewriteBuffers that are involved. 
  *Through SourceLocation,it can edit source code by inserting,
  ...
  ************************************************/
  ...
  //Find some information about the function declaration
